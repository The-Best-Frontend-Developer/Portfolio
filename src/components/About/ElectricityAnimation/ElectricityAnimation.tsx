...
const ElectricityAnimation = () => {
    ...
    return (
        <div className={`absolute hidden lg:flex customContainer max-w-[100vw] overflow-x-clip -z-10 bottom-0 left-1/2 transform -translate-y-1/2 lg:translate-y-0 -translate-x-1/2 pointer-events-none max-h-fit w-fit ${isShow ? 'dash' : ''}`} ref={elementRef}>
